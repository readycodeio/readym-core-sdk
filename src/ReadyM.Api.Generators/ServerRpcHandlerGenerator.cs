        ...
        foreach (var group in groupsByClass)
        {
            ...
            foreach (var method in group)
            {
                ...
                for (var i = 0; i < parameters.Length; i++)
                {
                    ...
                    else if (param.Type.Name == PlayerIdTypeName)
                    {
                    ...
                    else if (param.Type.Name == EventCodeTypeName)
                    {
                        if (param.Name != EventCodeParameterName)
                        {
                            valid = false;
                            break;
                        }
                    ...
                    else if (param.Type.AllInterfaces.Any(i => i.Name == "INetSerializable"))
                    {
                        // T payload
