...
public class NativeFixedTests
{
    ...
    {
        var lst = new NativeFixed<int, Storage32<int>>();
    ...
    public void TestInsertRangeList(int initialCapacity)
    {
        ...
        var source = new NativeFixed<int, Storage32<int>>();
        source.Add(234);
        source.Add(123);
    ...
    public void TestEnsureLength()
    {
        ...
        resized = lst.EnsureLength(lst.Capacity);

        Assert.IsTrue(resized);
        Assert.AreEqual(lst.Capacity, lst.Count);
        Assert.GreaterOrEqual(lst.Capacity, lst.Capacity);
